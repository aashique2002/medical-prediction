...
diabetes_model = pickle.load(open('C:/Users/Acer/OneDrive/Desktop/multiple dieases prediction/saved models/diabetes_model.sav','rb'))
heart_disease_model = pickle.load(open('C:/Users/Acer/OneDrive/Desktop/multiple dieases prediction/saved models/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('C:/Users/Acer/OneDrive/Desktop/multiple dieases prediction/saved models/parkinsons_model.sav','rb'))
autism_model = pickle.load(open('C:/Users/Acer/OneDrive/Desktop/multiple dieases prediction/saved models/autism_model (1).sav','rb')) 
